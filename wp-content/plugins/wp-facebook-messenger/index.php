<?php
/*
Plugin Name: WP Facebook Messenger
...
function ninja_facebook_messenger_chat_on_plugin_activation() {
    add_option("facebook_messenger_user","https://www.facebook.com/facebook");
...
add_filter( 'plugin_row_meta', "ninja_plugin_messenger_row_meta", 10, 2 );

function ninja_plugin_messenger_row_meta( $links, $file ) {
...
add_filter('plugin_action_links_'.plugin_basename(__FILE__), 'ninja_messenger_add_plugin_page_settings_link');
function ninja_messenger_add_plugin_page_settings_link( $links ) {
    $links[] = '<a href="' .
