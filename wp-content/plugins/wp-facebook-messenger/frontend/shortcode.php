...
function ninja_facebook_messenger_shortcode( $atts, $content = null){
  ...
  <div id="<?php echo $id ?>" class="facebook_messenger_popup">
        ...
        <?php } ?>
        <div class="fb-page" data-with="350" data-height="310" data-href="<?php echo $array['url'] ?>" data-tabs="messages" data-small-header="true" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="false"><div class="fb-xfbml-parse-ignore"><blockquote cite="<?php echo $array['url'] ?>"><a href="<?php echo $array['url'] ?>">Loading...</a></blockquote></div></div>
  </div>
...
add_shortcode( 'messenger', 'ninja_facebook_messenger_shortcode' );
