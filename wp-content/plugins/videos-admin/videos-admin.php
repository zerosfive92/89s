...
License: GPL
*/
require_once('controllers/VideosManagementController.php');

add_action('admin_menu', 'videos_admin_plugin');
 
function videos_admin_plugin(){
        add_menu_page( ' Videos', ' Videos', 'edit_posts', 'videos-management-plugin', 'videos_management_init' );
}


function videos_management_init(){

    wp_register_style( 'boostrap4css', plugins_url() . '/videos-admin/lib/bootstrap.min.css' );
    wp_enqueue_style( 'boostrap4css' );

    wp_register_style( 'videosAdminStyle', plugins_url() . '/videos-admin/css/video_admin_style.css' );
    wp_enqueue_style( 'videosAdminStyle' );

    wp_register_script('boostrap4js', plugins_url() . '/videos-admin/lib/bootstrap.min.js');
    wp_enqueue_script('boostrap4js');

	//test_handle_post();
	wp_enqueue_script('videos-admin-ajax', plugins_url() . '/videos-admin/js/videosadmin.ajax.js');
